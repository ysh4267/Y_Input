...
```powershell
powershell -File tools\rune-regress.ps1        # 빌드 + 22세트 리플레이 + expected.txt 대조
...
| `rune-frames-DDUU-bannertext-20260805` | 확장 밴드 안내문 텍스트 잡줄(X격자 동일·40px 위)·Y매칭+프로브 경쟁 근거 | ⑦w·⑧ 457/564/671/733 ±5 · ③ ↓↓↑↑ · ④불일치 4슬롯·프로브 웜/④ 2.11× |
